...
4. Treat pre-v2 artifacts as out-of-scope for runtime logic.
5. If a historical migration concern appears, resolve it operationally outside runtime code, not via compatibility implementation.
