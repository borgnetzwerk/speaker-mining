...
3. Wikidata projections (graph-first/fallback outputs):
   ...
   - data/20_candidate_generation/wikidata/projections/instances_core_episodes.json
   - data/20_candidate_generation/wikidata/projections/instances_core_persons.json
   - data/20_candidate_generation/wikidata/projections/instances_core_topics.json
   - data/20_candidate_generation/wikidata/projections/instances_core_roles.json
   - data/20_candidate_generation/wikidata/projections/instances_core_organizations.json
