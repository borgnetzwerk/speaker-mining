> **ARCHIVED 2026-04-23** — This document records the 2026-04-11 redesign sprint that produced an intermediate implementation. The current production implementation under `speakermining/src/process/entity_disambiguation/` supersedes these modules. File names and architecture described here (e.g. `alignment.py`, `data_loading.py`, `event_handlers.py`) differ from the current implementation. Do not use this document to understand the live codebase.
