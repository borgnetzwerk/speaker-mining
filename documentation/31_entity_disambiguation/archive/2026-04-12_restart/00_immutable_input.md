> **ARCHIVED 2026-04-23** — This directory contains the V2 restart design documents from 2026-04-12. The design was superseded by the current production implementation. For the live codebase, see `speakermining/src/process/entity_disambiguation/`.
